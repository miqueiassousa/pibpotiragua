            ...
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-light justify-content-between">
                    ...
                    <div class="redesocial-menu">
                        <ul class="list">
                            <li>
                                <a href="https://www.facebook.com/pibjerusalempotiragua" target="_blank"
                                    rel="noopener noreferrer"><i class="redesocial fa-brands fa-facebook"></i></a>
                            </li>

                            <li>
                                <a href="https://www.instagram.com/juventudepibj/" target="_blank"
                                    rel="noopener noreferrer"> <i class="redesocial fa-brands fa-instagram"></i></i></a>
                            </li>
                        </ul>
